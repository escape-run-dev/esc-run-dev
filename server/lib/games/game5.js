...
describe("Calcular los resultados de los Celtics",() => {
    it("Debe devolver los resultados cuando el nombre del equipo es correcto",() => {    
         expect(nbaCup(r, "Boston Celtics")).toEqual("Boston Celtics:W=4;D=0;L=0;Scored=403;Conceded=350;Points=12")
     })
     it("Debe devolver 'Team Name:This team didn't play!' cuando el nombre del equipo no es correcto", () => {
         expect(nbaCup(r, "Boston Celt")).toEqual("Boston Celt:This team didn't play!")
     })
 })` 
